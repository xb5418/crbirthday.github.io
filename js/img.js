$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
            ...
            $('.begin').html('<a href="../html/Memories.html" style="text-decoration: none;color: #fff;background: skyblue;display: inline-block;padding: 10px;border: 2px solid #fff;">开启浪漫回忆</a>');
            $('.begin').fadeIn();
            return;
        }
    };
